...
SOURCEFILES := ../../../../PAWLIN/IP/PWNGeneral/PWNCvSettings_Linux.cpp DataManager.cpp DefectDetector.cpp ../../../../PAWLIN/IP/PWNGeneral/ArgParser.cpp ../../../../PAWLIN/IP/PWNGeneral/pwnutil.cpp ../../../../PAWLIN/IP/PWNGeometry/Plane3Df.cpp ../../../../PAWLIN/IP/PWNGeometry/Point3Df.cpp ../../../../PAWLIN/IP/PWNStereo/DepthProcessor.cpp ImagePreparator.cpp main.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/PWNCvSettings_Linux.o : ../../../../PAWLIN/IP/PWNGeneral/PWNCvSettings_Linux.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/ArgParser.o : ../../../../PAWLIN/IP/PWNGeneral/ArgParser.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/pwnutil.o : ../../../../PAWLIN/IP/PWNGeneral/pwnutil.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/Plane3Df.o : ../../../../PAWLIN/IP/PWNGeometry/Plane3Df.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/Point3Df.o : ../../../../PAWLIN/IP/PWNGeometry/Point3Df.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/DepthProcessor.o : ../../../../PAWLIN/IP/PWNStereo/DepthProcessor.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)
